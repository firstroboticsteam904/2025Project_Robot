...
public class AlgaeLevel3CMD extends ParallelCommandGroup {
  /** Creates a new IntakeLevelCMD. */
  Elevator kElevator;
  intakeClaw kIntakeClaw;
  public AlgaeLevel3CMD(Elevator kElevator, intakeClaw kIntakeClaw) {
    this.kElevator = kElevator;
    this.kIntakeClaw = kIntakeClaw;
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new elevatorNonPID(kElevator, 82, 79),
